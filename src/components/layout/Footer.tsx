...
const navigation = {
  ...
  resources: [
    ...
    { name: "GitHub", href: "https://github.com/Sarwarhridoy4/FyClip---Advanced-Clipboard-Manager" },
    { name: "Discord", href: "#" },
    { name: "Blog", href: "#" },
  ],
  legal: [
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="space-y-4">
              <Link href="/" className="flex items-center gap-2">
                <div className="w-10 h-10 neo-raised flex items-center justify-center">
                  <span className="text-2xl font-bold text-(--neo-primary)">F</span>
                </div>
